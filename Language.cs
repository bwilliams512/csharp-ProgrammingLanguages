...
namespace ProgrammingLanguages
{
  public class Language
  {
    ...
    // Step 11a
    // Write a method PrintAll() that prints every query result in this project
    public static void PrintAll(IEnumerable<Object> sequence) 
    {
      foreach (var qResults in sequence)
      {
        Console.WriteLine(qResults);
      }
    }
    
    // Step 10a
    // Write a method PrettyPrintAll()that prints every Language in this project
